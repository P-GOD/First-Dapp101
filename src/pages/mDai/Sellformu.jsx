...
import tokenLogo from "./../../resources/dai.png";
      ...
      >
        <div> 
          ...
          <span className="float-right text-muted">
            Balance:{window.web3.utils.fromWei(this.props.daiBalance.toString())}
          </span>
        </div>
        ...
        <div className="mb-5">
          ...
          <span className="float-right text-muted">1 mDai = 3 ONE</span>
        </div>
