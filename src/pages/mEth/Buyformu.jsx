...
import tokenLogo from "./../../resources/ethtoken.png";
    ...
    return (
      <form
        ...
        onSubmit={(event) => {
          ...
          this.props.buyEther(etherAmount);
        }}
      >
        <div>
        ...
        <div>
          ...
          <span className="float-right text-muted">
            Balance: {window.web3.utils.fromWei(this.props.ethBalance.toString())}
          </span>
        </div>
        ...
        <div className="mb-5">
          ...
          <span className="float-right text-muted">1 ONE = 1 mETH</span>
        </div>
